...
- For gRPC framework proto: ```protoc --go-grpc_out=. --go-grpc_opt=paths=source_relative proto/agent.proto```
- For response/request object setter and getter proto: ```protoc --go_out=. --go_opt=paths=source_relative proto/agent.proto```

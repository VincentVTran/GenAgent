...
type AgentClient interface {
	// Sends a greeting
	SayHello(ctx context.Context, in *AgentRequest, opts ...grpc.CallOption) (*AgentReply, error)
}
...
type AgentServer interface {
	// Sends a greeting
	SayHello(context.Context, *AgentRequest) (*AgentReply, error)
...
func (UnimplementedAgentServer) SayHello(context.Context, *AgentRequest) (*AgentReply, error) {
